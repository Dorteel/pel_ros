...
def get_ros2_nodes(*args):
    ...
    # RViz
    rviz_config = os.path.join(get_package_share_directory('simulation'), 'resource', 'default_bringup.rviz')
    rviz = Node(
        package='rviz2',
        executable='rviz2',
        output='screen',
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Choose one of the world files from `/simulation/world` directory'
        ),
        DeclareLaunchArgument(
            'mode',
